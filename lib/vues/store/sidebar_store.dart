                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        StreamBuilder<DocumentSnapshot>(
                          stream: FirebaseFirestore.instance.collection('store').doc(Store.user.uid).snapshots(),
                          builder: (context, snapshot) {
                            return !snapshot.hasData?Text("")
                                :ListTile(
                              title: Text(snapshot.data.data()[Store.storeName],style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.w800),),
                              subtitle: Text(snapshot.data.data()[Store.storeEmail],style:TextStyle(color: Colors.white.withAlpha(100),fontSize: 15),),
                        ...
                        MenuItem(
                          ...
                          onTap: (){
                            onIconPressed();
                            BlocProvider.of<NavigationBloc>(context).add(StoreNavigationEvents.MainPageClickedEvent);
                          },
                        ),
                        MenuItem(
                          ...
                          onTap: (){
                            onIconPressed();
                            BlocProvider.of<NavigationBloc>(context).add(StoreNavigationEvents.CommandesClickedEvent);
                          },
                        ),
                        MenuItem(
                          icon: Icons.fastfood,
                          ...
                          onTap: (){
                            onIconPressed();
                            BlocProvider.of<NavigationBloc>(context).add(StoreNavigationEvents.ProductsClickedEvent);
                          },
                        ),
                        Divider(
                          height: 64,
